...
# ======================================================================================================================
def load_mubi(args, **kwargs):

    unique_sid = list()
    with open(os.path.join("datasets", "mubi", 'unique_sid.txt'), 'r') as f:
        for line in f:
            unique_sid.append(line.strip())
    ...
    # train, validation and test data
    x_train = load_train_data(os.path.join("datasets", "mubi", 'train.csv'))
    np.random.shuffle(x_train)
    x_val_tr, x_val_te = load_tr_te_data(os.path.join("datasets", "mubi", 'validation_tr.csv'),
                                         os.path.join("datasets", "mubi", 'validation_te.csv'))

    x_test_tr, x_test_te = load_tr_te_data(os.path.join("datasets", "mubi", 'test_tr.csv'),
                                           os.path.join("datasets", "mubi", 'test_te.csv'))
...
def load_dataset(args, **kwargs):
    ...
    elif args.dataset_name == 'mubi':
        train_loader, val_loader, test_loader, args = load_mubi(args, **kwargs)
